        ...
        <section id="home" className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <div className="container px-4 md:px-6 lg:px-8 xl:px-10">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                A self-taught developer with a background in Applied Geology,
                specializing in creating user-centric web experiences with
            ...
            <Card>
              <CardContent className="space-y-4 pt-6">
                ...
                <p>
                  ...
                  focusing on AI-powered newsletter applications and
                  mobile-responsive websites. My goal is to create intuitive,
                  efficient, and scalable web solutions that make a real
                  difference for users and businesses alike.
                </p>
              </CardContent>
            </Card>
          </div>
